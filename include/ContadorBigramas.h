...
class ContadorBigramas{
    ...
    public:
        ...
        */
        bool addBigrama(const char cadena[], int frecuencia=1);
        ...
        */
        ...
        /*
         * @brief Extrae todos los bigramas de cada palabra y los almacena en la matriz
         * @param palabra: palabra que recibe del fichero   
        */
        void ExtraerBigramas(string& palabra);
        ...
        */
        void fromIdioma(const Idioma &id);
};
